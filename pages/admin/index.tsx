...
function Admin() {
    ...
    const getNftsOnSale = async () => {
        const res = await contract?.getAllNftsOnSale();
        return res!.wait();
    }

    const [nftsOnSale,  setNftsOnSale] = useState(getNftsOnSale());
                ...
                <div>
                    <div className="md:grid md:grid-cols-3 md:gap-6">
                            ...
                            <div className="px-4 sm:px-0">
                                ...
                                <div
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                        <div>
                                            <h3 className="text-lg font-medium leading-6 text-sky-900">Total NFTs:</h3>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            <h3 className="text-lg font-medium leading-6 text-sky-900">Create at last
                                                day:</h3>
                                        </div>
                                        <div>
                                ...
                                <div
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                        ...
                                        <div>
                                            <h3 className="text-lg font-medium leading-6 text-sky-900 pl-10">567</h3>
                                        </div>
                                        <div>
                                            <h3 className="text-lg font-medium leading-6 text-sky-900">Sale at last
                                                day:</h3>
                                        </div>
                                        <div>
                                            <h3 className="text-lg font-medium leading-6 text-sky-900 pl-10">Coming
                                ...
                                <div
                                    ...
                                    <p className="mt-1 text-sm text-gray-600">
                                        The total amount that is stored on the platform. (Ether is transferred only to
                                        the owner wallet) </p>
                                    <form action="">
                                        <div className="flex">
                                            <div className="flex-initial w-64">
                                                <input
                                                    ...
                                                    id="countSend" type="number" placeholder="0.1"/>
                                            </div>
                                ...
                                <div
                                    ...
                                    <p className="mt-1 text-sm text-gray-600">
                                        Price in the ether how much does it cost to place NFTs on the marketplace.
                                    </p>
                                    <form action="">
                                        <div className="flex">
                                            <div className="flex-initial w-64">
                                                <input
                                                    className="shadow appearance-none border rounded w-full py-2 px-3 text-sky-900 leading-tight focus:outline-none focus:shadow-outline"
                                                    id="countSend" type="number" placeholder="0.025"/>
                                            </div>
                                            <div className="flex-initial w-32">
                                                <button
                                                    type="submit"
                        ...
                        <div className="mt-5 md:mt-0 md:col-span-2">
                            <div className="shadow sm:rounded-md sm:overflow-hidden px-4 py-5 bg-white space-y-6 sm:p-6 mb-5">
                            ...
                            <div className="shadow sm:rounded-md sm:overflow-hidden px-4 py-5 bg-white space-y-6 sm:p-6">
                                ...
                                <div className="grid grid-cols-2 gap-1">
                                    <div className="m-auto">
                                        ...
                                        <p className="mt-1 text-sm pb-3 text-gray-600">
                                            There can only be 1 owner of a resource, you can change the owner of a
                                    ...
                                    <Dialog.Panel
                                        ...
                                        <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                                ...
                                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                                    ...
                                                    <div className="mt-2">
                                                        <p className="pb-2 text-sm text-justify text-gray-500">
                                                            Are you sure you want to change the owner of this resource ?
                                            ...
                                            <div className="p">
                                                <input
                                                    className="shadow appearance-none border rounded w-full py-2 px-3 text-sky-900 leading-tight focus:outline-none focus:shadow-outline"
                                                    id="countSend" type="number" placeholder="address current owner"/>
                                            </div>
                                        </div>
